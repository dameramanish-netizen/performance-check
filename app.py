...
if uploaded_file is not None:
    ...
    col_scan, col_clear, _ = st.columns([1.5, 1.5, 4])
    with col_scan:
        click_scan = st.button("🚀 Analyze Log Trace", type="primary", use_container_width=True)
    with col_clear:
        click_clear = st.button("🗑️ Reset and Clear Data", type="secondary", use_container_width=True)
